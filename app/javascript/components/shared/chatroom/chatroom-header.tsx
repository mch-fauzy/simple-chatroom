...
export const ChatroomHeader: React.FC<ChatroomHeaderProps> = ({ chatroomName, isConnected, messageCount }) => {
  return (
    <div className="relative p-6 border-b bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-white tracking-tight">{chatroomName}</h1>
